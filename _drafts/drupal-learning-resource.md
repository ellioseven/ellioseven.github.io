---
layout: "post"
title: "Drupal Learning Resources"
lede: "A collection of curated Drupal knowledge"
---
## APIs
...
* [Drupal.org - Field API](https://api.drupal.org/api/drupal/core%21modules%21field%21field.module/group/field/8.6.x)
...
* [Drupal.org - Locking](https://api.drupal.org/api/drupal/core%21lib%21Drupal%21Core%21Lock%21LockBackendInterface.php/group/lock/8.3.x)
...
* [Drupal.org - Testing API](https://api.drupal.org/api/drupal/core%21core.api.php/group/testing/8.3.x)
...
* [YouTube - DrupalCon Nashville 2018: Advanced Configuration Management in Drupal 8](https://youtu.be/x2kYZhgUSU0)
* [YouTube - DrupalCon New Orleans 2016: Configuration Management for Developers in Drupal 8](https://youtu.be/F9E0jPwwu54)
* [YouTube - DrupalCon Nashville 2018: Configuration Management for Humans](https://youtu.be/nLUHG5WTO60)
...
* [YouTube - DrupalCon Nashville 2018: Media Module in Core: Setting Up a Drupal 8 Media Library](https://youtu.be/grYtgcZyQBA)
...
* [YouTube - DrupalCon Nashville 2018: Building "cooperative" APIs with HTTP/2](https://youtu.be/78BYVc7OJlE)
* [YouTube - DrupalCon Nashville 2018: Advanced Topics in Decoupled Drupal](https://youtu.be/o5n4wfWfKrw)
* [YouTube - DrupalCon Nashville 2018: Decoupled Drupal Hard Problems](https://youtu.be/3wHl0_jHpzU)
* [YouTube - DrupalCon Nashville 2018: Creating a Modern Web Application](https://youtu.be/p30Fbdu7qBE)
* [YouTube - DrupalCon Vienna 2017: Introduction to Decoupled Drupal](https://youtu.be/dgbQn2bfKJI)
* [YouTube - DrupalCon Vienna 2017: Easy decoupled sitebuilding with GraphQL and Next.js](https://youtu.be/XcWsa3s8GnE)

## Symfony

* [YouTube - DrupalCon Vienna 2017: Tour of the 35 Symfony Components](https://youtu.be/TxKkYuNmoK8)
* [YouTube - DrupalCon Vienna 2017: Symfony in Drupal 8: How Much and What Does Drupal Inherit from Symfony](https://youtu.be/sbP9T2LAUxw)
...
* [YouTube - DrupalCon Nashville 2018: Static Analysis for your Drupal modules with CI](https://youtu.be/BRiEhm2mplk)
...
* [YouTube - DrupalCon Nashville 2018: Debugging Effectively](https://youtu.be/WhBUTu4Kipg)
...
- [DrupalCon Vienna 2017: Drush 9 - Lean and Modern](https://youtu.be/FNzXI_VRF48)
...
* [Elements](https://api.drupal.org/api/drupal/elements/8.6.x)
